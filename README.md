...
<head>
  ...
  <link rel="stylesheet" href="https://unpkg.com/handsfree@8.2.5/build/lib/assets/handsfree.css" />
  <script src="https://unpkg.com/handsfree@8.2.5/build/lib/handsfree.js"></script>
</head>
...
The above will load models, some over 10Mb, from the [Unpkg CDN](https://unpkg.com/browse/handsfree@8.2.5/build/lib/assets). If you'd rather host these yourself (for example, to use offline) then you can eject the models from the npm package into your project's public folder:
